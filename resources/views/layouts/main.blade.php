                    ...
                    <form action="{{ route('search') }}" method="GET" id="searchForm">
                        <div class="search-input-wrapper">
                            <input type="text" name="q" class="form-control form-control-lg search-input"
                                placeholder="{{ __('common.search_placeholder') }}" autofocus
                                value="{{ request('q') }}">
                        ...
                        <div class="popular-searches mt-4">
                            ...
                            <div class="d-flex flex-wrap gap-2">
                                <a href="{{ route('search', ['q' => 'Cummins']) }}"
                                    class="badge bg-light text-dark">Cummins</a>
                                <a href="{{ route('search', ['q' => 'Doosan']) }}"
                                    class="badge bg-light text-dark">Doosan</a>
                                <a href="{{ route('search', ['q' => 'VMAN']) }}"
                                    class="badge bg-light text-dark">VMAN</a>
                                <a href="{{ route('search', ['q' => '100kVA']) }}"
                                    class="badge bg-light text-dark">100kVA</a>
                                <a href="{{ route('search', ['q' => '200kVA']) }}"
                                    class="badge bg-light text-dark">200kVA</a>
                                <a href="{{ route('search', ['q' => 'silent']) }}"
                                    class="badge bg-light text-dark">{{ __('common.silent_generator') }}</a>
                            </div>
                        </div>
                    </form>
                </div>
